...
func (k *SeekrEPHandler) Reverse(ctx context.Context, state request.Request, exact bool, opt plugin.Options) ([]msg.Service, error) {
...
func (k *SeekrEPHandler) serviceRecordForIP(ip, name string) []msg.Service {
